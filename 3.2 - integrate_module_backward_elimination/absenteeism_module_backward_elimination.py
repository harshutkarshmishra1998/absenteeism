...
class absenteeism_model():
        ...
        def __init__(self, model_file, scaler_file):
            ...
            with open('model_backward_elimination', 'rb') as model_file, open('scaler_backward_elimination', 'rb') as scaler_file:
        ...
        def load_and_clean_data(self, data_file):
            ...
            df = df.drop(['Distance to Work', 'Age', 'Daily Work Load Average'], axis=1)
